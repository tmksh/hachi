  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:text-[#0F5132] data-[state=active]:font-semibold " +
        "group-data-[variant=default]/tabs-list:data-[state=active]:bg-[#D8EDE4] " +
        "group-data-[variant=default]/tabs-list:data-[state=active]:shadow-[0_1px_2px_rgba(15,81,50,0.10)] " +
        "dark:group-data-[variant=default]/tabs-list:data-[state=active]:bg-[rgba(42,128,85,0.25)] " +
