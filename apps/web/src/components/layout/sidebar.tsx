...
interface SidebarProps {
  ...
  onBridgeChatOpen?: () => void;
}

export const Sidebar = memo(function Sidebar({ profile, onSignOut, expanded, onExpandedChange, onInternalChatOpen, onBridgeChatOpen }: SidebarProps) {
