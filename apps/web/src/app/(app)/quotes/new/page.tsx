...
function QuoteNewPageContent() {
  ...
  if (step === "customer") {
    return (
      <div className="p-4 md:p-6 space-y-4 max-w-lg">
        <div className="flex items-center gap-3"><Link href="/quotes"><Button variant="ghost" size="icon" className="size-8"><ArrowLeft className="size-4" /></Button></Link><h1 className="text-2xl font-semibold tracking-tight text-[#0F5132]">顧客を選択</h1></div>
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex items-center gap-3"><Button variant="ghost" size="icon" className="size-8" onClick={() => setStep("customer")}><ArrowLeft className="size-4" /></Button><h1 className="text-2xl font-semibold tracking-tight text-[#0F5132]">新規見積作成</h1></div>
