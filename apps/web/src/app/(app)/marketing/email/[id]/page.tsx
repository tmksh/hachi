...
export default function MarketingEmailDetailPage() {
  ...
  if (!data) return <div className="p-4 md:p-8 space-y-6"><Link href="/marketing/email" className="text-sm text-muted-foreground flex items-center gap-1"><ArrowLeft className="h-4 w-4" />戻る</Link><p className="mt-4">見つかりません</p></div>;
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      ...
      <h1 className="text-2xl font-semibold tracking-tight">{data.subject || "(件名なし)"}</h1>
